...
public class CheckOut extends JFrame implements ActionListener{
    ...
    CheckOut(){
        ...
        add(b2);
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("GRWPLInstituteManagementSystem/icons/tick.png"
                + ""));
        ...
        add(b3);
         ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("GRWPLInstituteManagementSystem/icons/sixth.jpg"));
