...
public class AddStudents extends JFrame implements ActionListener{
    ...
    AddStudents(){
        ...
        add(t3);
        JLabel model=new JLabel("Mobile Number");
        ...
        add(b2);
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("GRWPLInstituteManagementSystem/icons/loginbg40.jpeg"));
