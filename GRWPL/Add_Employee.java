...
class Add_Employee implements ActionListener{
    ...
    Add_Employee(){
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("GRWPLInstituteManagementSystem/icons/add_employee.jpg"));
        id15.setIcon(img);
        ...
        id1.setForeground(Color.YELLOW);
        id15.add(id1);
        ...
        id2.setForeground(Color.YELLOW);
        id15.add(id2);
        ...
        id3.setForeground(Color.YELLOW);
        id15.add(id3);
        ...
        id4.setForeground(Color.YELLOW);
        id15.add(id4);
        ...
        id5.setForeground(Color.YELLOW);
        id15.add(id5);
        ...
        id6.setForeground(Color.YELLOW);
        id15.add(id6);
        ...
        id7.setForeground(Color.YELLOW);
        id15.add(id7);
        ...
        id9.setForeground(Color.YELLOW);
        id15.add(id9);
        ...
        id10.setForeground(Color.YELLOW);
        id15.add(id10);
        ...
        id11.setForeground(Color.YELLOW);
        id15.add(id11);
        ...
        id12.setForeground(Color.YELLOW);
        id15.add(id12);
