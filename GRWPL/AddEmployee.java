...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    AddEmployee(){
        ...
        add(job);
        String str[]={"Front Desk Clerks","Porters","Housekeeping","Kitchen Stuff","Room service","waiter/Waitress","Manager","Accountant","Chef"};
        ...
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("GRWPLInstituteManagementSystem/icons/loginbg10.jpeg"));
        ...
        l2.setBounds(420,20,400,30);
        l2.setFont(new Font("Tahoma",Font.PLAIN,31));
        add(l2);
        
        getContentPane().setBackground(Color.YELLOW);
        setLayout(null);
        setBounds(220,120,850,540);
        setVisible(true);
