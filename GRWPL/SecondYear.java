...
import javax.swing.*;
public class SecondYear extends JFrame implements ActionListener{
    ...
    SecondYear(){
       ...
       label1=new JLabel("Second Year Admission");
       ...
       ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("GRWPLInstituteManagementSystem/icons/sy.jpeg"));
