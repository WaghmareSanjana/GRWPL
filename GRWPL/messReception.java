...
public class messReception extends JFrame implements ActionListener{
    JButton b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,b12;
    messReception(){
        setUndecorated(true);
        b1=new JButton("New Student Form");
        ...
        add(b12);
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("GRWPLInstituteManagementSystem/icons/loginbg5.jpg"));
JLabel l1=new JLabel(i1);
l1.setBounds(250,30,500,470);
add(l1);
        getContentPane().setBackground(Color.RED);
        setLayout(null);
        setBounds(230,130,790,550);
        setVisible(true);
    }
