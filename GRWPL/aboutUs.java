	...
	private JPanel contentPane;
        ...
        public aboutUs() {
          ...
          //  setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\ram\\Desktop\\rohit.jpg"));
            ...
            ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("GRWPLInstituteManagementSystem/icons/logo.png"));
            ...
            JLabel l6 = new JLabel("Developed By : GRWPL");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Contact Us : GRWPL123@gmail.com");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);
            
            JLabel l10 = new JLabel("**If you want us to make Java book for you, drop a mail**");
