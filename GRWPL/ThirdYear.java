...
import javax.swing.*;
public class ThirdYear extends JFrame implements ActionListener{
    ...
    ThirdYear(){
       ...
       label1=new JLabel("Third Year Admission");
       label1.setBounds(830,50,1000,30);
       ...
       l16=new JLabel("2ndYear Percentage");
       ...
       ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("GRWPLInstituteManagementSystem/icons/ty.jpeg"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        {
            try{
            JOptionPane.showMessageDialog(null,"Second Year student Successfully Registered!!");
            t1.setText("");
            t2.setText("");
            t3.setText("");
            t4.setText("");
